        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">Koppiauto</h3>
                <p className="text-gray-400 text-sm">Kun tarvitset tilaa</p>
              </div>
            </div>
            <p className="text-gray-300 text-sm">
              Luotettava Volkswagen LT35 pakettiauto vuokraus Tampereen alueella.
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <span>Aaltotie 8, 33180 Tampere</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              ...
              <li>• Viikonloppuvuokra (150€) pe 8 - su 21</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Koppiauto. Kaikki oikeudet pidätetään.
            </p>
            <p className="text-gray-400 text-sm mt-2 sm:mt-0">
              Kun tarvitset tilaa - Koppiauto
            </p>
          </div>
        </div>
      </div>
